...
// Centers the map when user location changes
...
function Starting() {
  ...
  useEffect(() => {
    if (navigator.geolocation) {
      navigator.geolocation.getCurrentPosition(
        ...
        () => {
          // geolocation unavailable or denied — location stays null
        }
      );
    }
  }, []);
  ...
  const submitHandle = () => {
    ...
    if (!age || !gender || !weight || !height || !time) {
      ...
      setFull(true);
      setDetails({ age: '', gender: '', weight: '', height: '', Mode: '', time: '' });
    }
  };
  ...
  return (
    <div className='w-100 d-md-flex align-items-center justify-content-center'>
        ...
        <div className='border border-primary p-2 rounded w-75 mt-md-4' id='cont'>
          ...
          >
            ...
            <FormControl className='w-75 mt-3' focused>
              <InputLabel id="gender-label" color='dark' variant="outlined">Gender</InputLabel>
              <Select
            ...
            />
            <FormControl className='w-75 mt-3' focused>
              <InputLabel id="mode-label" color='dark' variant="outlined">Mode</InputLabel>
              <Select
                labelId="mode-label"
                id="mode-select"
                value={details.Mode}
            ...
            <TextField
              id="field-time"
              value={details.time}
              label="Time for Activity (in min)"
              variant="outlined"
          ...
          <div className='d-flex align-items-center justify-content-center mb-3'>
            ...
            <Link to={'/Getsuggestion'} className='ms-3'>
              <Button variant="warning">Test File</Button>
            </Link>
          </div>
        </div>
      )}
      ...
      {full && (
        <div className="w-100 mt-4 p-3 border border-info rounded">
          <div className="d-flex w-100 align-items-center justify-content-center mb-3 ms-md-2">
            <form className="w-100 d-flex align-items-center">
              <FontAwesomeIcon icon={faLocationDot} size="lg" className="text-danger me-1" />
              <input
                type="text"
